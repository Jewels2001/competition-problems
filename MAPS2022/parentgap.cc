...
// 2022:
// May 8 = second sunday in May
// June 19 = third sunday in June

int main() {
  Date mother(2022, 5, 8);
  Date father(2022, 6, 19);
  ...
  if(test1 == 0) {
    ...
    int test5 = (7 - (test1 % 7)) + 7;
    a.addDay((7 - (test1 % 7)) + 7);
  }
  ...
  if(test2 == 0) {
    ...
    int test5 = (7 - (test2 % 7)) + 14;
    b.addDay((7 - (test2 % 7)) + 14);
  }

  // cout << b.yyyy << " " << b.mm << " " << b.dd << endl;
