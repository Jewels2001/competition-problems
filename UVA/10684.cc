/*
By: Julie Wojtiw-Quo
Maximum sub-vector sum problem -> used vecsum.cc to 'Find the contiguous
subvector that gives the largest sum.' Input is vector, uses ternary statement
to check if sum is greater than 0 or not.
*/
...
int main(void)
{
  ...
  while (cin >> n && n > 0) {
    ...
    (sum > 0) ? cout << "The maximum winning streak is " << sum << "." :
                  cout << "Losing streak.";
    cout << endl;
    //<< start << " to " << end << "."
